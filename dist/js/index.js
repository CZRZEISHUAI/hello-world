...
var Element = {
	...
	//2.获取子元素节点
	getChildElement: function getChildElement(parent) {
		var sons = parent.childNodes; //所有的子节点
		return Element.getElement(sons);
	},
	//3.获取兄弟元素节点
	getNextElement: function getNextElement(ele) {
...
(function (a, b) {
  function cA(a) {
    ...
    }), A = e.uaMatch(z), A.browser && (e.browser[A.browser] = !0, e.browser.version = A.version), e.browser.webkit && (e.browser.safari = !0), j.test("聽") && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = e(c), c.addEventListener ? _C2 = function C() {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && status.indexOf(xhr.status) != -1) {
                ...
                goods.innerHTML = content.map(function (item) {
                    return "<li><div class=\"cover\"><a href=\"details.html?booksId=" + item.id + "\"><img src=\"../" + item.imgurl + "\"></a></div><div class=\"infor\"><div class=\"priceWrap\"><span class=\"sellPrice\">\xA5" + item.price + "</span><span class=\"discount\">(" + item.zhekou + "\u6298)</span><del class=\"price\">\xA5" + item.oldprice + "</del></div><h2 class=\"name\"><a href=\"#\">" + item.name + "</a></h2><div class=\"otherInfor\"><b>" + item.writer + "</b><i>/</i><b>" + item.chubanshe + "</b></div><div class=\"oparateButton\"><span class=\"buyButton\"  data-bookid=\"" + item.id + "\">\u52A0\u5165\u8D2D\u7269\u8F66</span><a href=\"#\" class=\"collectBtn\">\u6536\u85CF</a></div></div></li>";
                }).join("");
                page.innerHTML = "";
...
jQuery(function ($) {
    ...
    $denglu.on("click", function (e) {
        ...
        var _upwd = $upwd.val();
        e.preventDefault();
        $.get("../api/php/login.php?uname=" + _uname + "&upwd=" + _upwd, function (data) {
            if (data == "登录成功") {
...
jQuery.prototype.fangda = function ($ele, opt) {
    ...
    var move = function move($dv1, $dv2, $img1, $img2, $span, $dv3, $img3) {
...
jQuery(function ($) {
    ...
    $uname.on("blur", function () {
        ...
        if (/^[\D\S][\S]{1,11}$/.test(_uname)) {
            $.get("../api/php/register.php?uname=" + _uname, function (data) {
                var res = data;
                console.log(data);
                if (res == true) {
    ...
    $upwd.on("blur", function () {
        ...
        if (/^[a-z]\w{1,11}$/.test($upwd.val())) {
            ...
            $upwd.next().html("密码应以字母开头，2-12位").css({
                "color": "red",
                "font-size": "14"
            });
            pwdStatus = false;
    ...
    $zhuce.on("click", function (e) {
        e.preventDefault();
        $.get("../api/php/zhuce.php?uname=" + $uname.val() + "&upwd=" + $upwd.val(), function (data) {
            if (data == "注册成功") {
